...
import awd.cloud.platform.servers.analyse.service.jls.Jls_XlzxService;
...
@RestController
@RequestMapping("/jls_xlzx")
@RefreshScope
@Api(tags = "jls_xlzx",description = "所长接待记录")
public class Jls_XlzxController {
    @Autowired
    private Jls_XlzxService jls_XlzxService;


    @GetMapping("/xlzxCount")
    @ApiOperation("业务动态")
    @OpenAPI
    public ResponseMessage<Map<String, Object>> xlzxCount( @RequestParam(value = "jsbh", required = false) String jsbh,
    		@RequestParam(value = "starttime", required = false) String starttime,
            @RequestParam(value = "endtime", required = false) String endtime) {
    	try {
	        Map<String, Object> result = new HashMap<String, Object>();
	        List<Map<String, Object>> list = jls_XlzxService.xlzxCount(jsbh,starttime,endtime);
	        result.put("xlzx", list);
