...
public class UsermenuEntity extends SimpleGenericEntity<String> {
	//alias
	public static final String TABLE_ALIAS = "菜单禁用管理";
	public static final String ALIAS_ID = "ID";
	public static final String ALIAS_JSBH = "监所编号";
	public static final String ALIAS_USERID = "用户编号";
	public static final String ALIAS_APPCODE = "应用编号";
	public static final String ALIAS_MENU = "菜单名";
    ...
    @Length(max=10,message="菜单名最大长度10位" ,groups=SaveGroup.class)
