...
public class MfingerEntity extends SimpleGenericEntity<String>  {
	...
	//columns START
		...
		@NotNull(message="证件号不能为空",groups=CreateGroup.class)
		@Length(max=21,message="证件号最大长度21位" ,groups=CreateGroup.class)
		private java.lang.String zjh;
	
		@NotNull(message="警号不能为空",groups=CreateGroup.class)
		@Length(max=255,message="警号最大长度255位" ,groups=CreateGroup.class)
