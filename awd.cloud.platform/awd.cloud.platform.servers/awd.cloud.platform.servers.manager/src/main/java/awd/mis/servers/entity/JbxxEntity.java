...
public class JbxxEntity extends SimpleGenericEntity<String> {
	...
	public static final String ALIAS_ddgy="单独关押(SHFO)";
	...
	@Length(max=1,message="单独关押标志(SHFO)最大长度1位" ,groups=CreateGroup.class)
	private  String ddgy;

	// columns END
	private String sfswsy;
	...
	public String getDdgy() {
		return ddgy;
	}

	public void setDdgy(String ddgy) {
		this.ddgy = ddgy;
	}
	
	public String getSfswsy() {
		return sfswsy;
	}

	public void setSfswsy(String sfswsy) {
		this.sfswsy = sfswsy;
	}

	String getDdgyString() {
		return CacheUtils.get().getDictionary("SHFO", this.getDdgy());
	}
}
