...
public class GroupmenusEntity extends SimpleGenericEntity<String> {
	
	//alias
	public static final String TABLE_ALIAS = "分组菜单";
    ...
    @Length(max=23,message="分组编号最大长度2000位" ,groups=SaveGroup.class)
    ...
    @Length(max=23,message="菜单编号最大长度23位" ,groups=SaveGroup.class)
