...
@EnableHystrix
@EnableFeignClients
public class ChartWebApplication implements CommandLineRunner{
	
    public static void main( String[] args ){
        SpringApplication.run(ChartWebApplication.class, args);
    }
    ...
    public void run(String... args) throws Exception {
    	System.out.println(">>>>>>>>>>>>>>信息研判系统启动<<<<<<<<<<<<<");

        System.out.println(">>>>>>>>>>>>>>信息研判系统启动结束<<<<<<<<<<<<<");
    }
}
