define("pages/index", [
    ...
    function (require) {
        ...
        var show = function(){
        	...
        	var show = '<iframe name = "iframe" scrolling="auto" frameborder="0"  src="'+showIndex+'" style="width:100%;height:'+height+'px"></iframe>'
        	$("#show").append(show);
            awd_pop.popwin("", $("#indexs").val());
        }
        //菜单点击事件 
        var showClick = function() {
        	$(".showone").each(function(){
				$(this).on('click',function(){
					...
					// console.log(index);
					var show = '<iframe scrolling="auto" frameborder="0"  src="'+index+'" style="width:100%;height:'+height+'px"></iframe>'
                    $("#show").append(show);
                });
            });
		}
