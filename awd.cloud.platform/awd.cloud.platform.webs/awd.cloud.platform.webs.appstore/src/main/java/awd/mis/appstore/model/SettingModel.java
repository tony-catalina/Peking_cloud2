...
public class SettingModel implements Model {
    ...
    private String getAppcodeString;
	//columns END


	public String getGetAppcodeString() {
		return getAppcodeString;
	}

	public void setGetAppcodeString(String getAppcodeString) {
		this.getAppcodeString = getAppcodeString;
	}
