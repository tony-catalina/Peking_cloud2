...
public class Kss_ThjyLsjyModel implements Model{	
	...
	public Kss_ThjyLsjyModel(){
	}
	public Kss_ThjyLsjyModel(String id) {
		this.id = id;
	}
	...
	public java.util.Date getRssj() {
		return this.rssj;
	}
	
	public void setRssj(java.util.Date value) {
		this.rssj = value;
	}
