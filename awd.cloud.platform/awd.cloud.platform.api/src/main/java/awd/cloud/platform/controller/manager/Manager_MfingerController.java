...
@Api(value = "Mfinger", description = "民警指纹信息")
public class Manager_MfingerController {
    @Autowired
    ...
    public ResponseMessage<PagerResult<Manager_MfingerModel>> mfinger_query(HttpServletRequest request,
        ...
        return managerService.mfinger_query(queryParam);
    }
}
