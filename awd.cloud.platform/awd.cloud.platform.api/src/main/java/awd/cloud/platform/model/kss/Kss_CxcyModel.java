...
public class Kss_CxcyModel implements Model{	
	...
	public Kss_CxcyModel(){
	}
	public Kss_CxcyModel(String id) {
		this.id = id;
	}
	...
	public java.lang.String getCylx() {
		return this.cylx;
	}
	
	public void setCylx(java.lang.String value) {
		this.cylx = value;
	}
