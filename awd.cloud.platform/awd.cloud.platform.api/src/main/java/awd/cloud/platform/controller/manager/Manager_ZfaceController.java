...
public class Manager_ZfaceController {
    @Autowired
    ...
    public ResponseMessage<PagerResult<Manager_ZfaceModel>> zface_query(HttpServletRequest request,
        ...
        return managerService.zface_query(queryParam);
    }
}
