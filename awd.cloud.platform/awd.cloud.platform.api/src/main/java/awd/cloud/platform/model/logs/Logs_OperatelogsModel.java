...
public class Logs_OperatelogsModel implements Model{	
	...
	public Logs_OperatelogsModel(){
	}
	public Logs_OperatelogsModel(String id) {
		this.id = id;
	}
	...
	public void setOpcontent(java.lang.String value) {
