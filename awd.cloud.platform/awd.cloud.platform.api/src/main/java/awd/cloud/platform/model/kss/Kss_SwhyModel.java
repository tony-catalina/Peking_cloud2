...
public class Kss_SwhyModel implements Model{	
	...
	private java.lang.String emcee;
	//columns END

	 

	public Kss_SwhyModel(){
	}
	public Kss_SwhyModel(String id) {
		this.id = id;
	}
	...
	public java.lang.String getEmcee() {
		return this.emcee;
	}
	
	public void setEmcee(java.lang.String value) {
		this.emcee = value;
	}
