...
public class Swagger2 {
    ...
    @Value("${swagger2.package.jnp}")
    private String jnpPackage;

    @Value("${swagger2.package.akyy}")
    private String akyyPackage;

    @Value("${swagger2.package.sjs}")
    private String sjsPackage;
    ...
    public Docket innerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("awd.cloud.platform.controller"))
    ...
    public Docket jnpApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(predicate)
                .apis(RequestHandlerSelectors.basePackage(jnpPackage))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(jnpApiInfo());
    }

    private ApiInfo jnpApiInfo() {
        return new ApiInfoBuilder()
                .title(title)//大标题
                .description("监内屏相关api文档")//详细描述
                .termsOfServiceUrl("http://www.njawd.com/")
                .license("所有公共api")
                .version("1.0")
                .build();
