...
@RestController
@RefreshScope
@RequestMapping("/v4/jwp/jwp_jssw")
@Api(tags = "jwp_jssw",description = "jssw")
public class Jwp_JsswController extends PublicService {
    ...
    /**
     * @api {get} /v4/jwp/jwp_jssw/jsswList 家属送物查询
     * @apiVersion 0.4.0
     * @apiName jsswList
     * @apiGroup g_jwp
     * @apiPermission any
     * @apiDescription 家属送物查询.
     *
    ...
    public ResponseMessage<Map<String, Object>> jsswList(HttpServletRequest request, @RequestParam(name = "appcode")String appcode, @RequestParam(name = "jsbh")String jsbh, String json) {

        String interfaceId = "/v4/jwp/jwp_jssw/jsswList";
