...
public class Kss_XlgyModel implements Model{	
	...
	public Kss_XlgyModel(){
	}
	public Kss_XlgyModel(String id) {
		this.id = id;
	}
	...
	public java.lang.String getGynr() {
		return this.gynr;
	}
	
	public void setGynr(java.lang.String value) {
		this.gynr = value;
	}
