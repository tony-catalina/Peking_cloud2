...
import awd.cloud.platform.controller.mjjk.Mjjk_MjjbxxController;
...
@RestController
@RefreshScope
@RequestMapping("/v4/jgywpt/mjjbxx")
@Api(tags = "jgywpt-mjjbxx",description = "mjjbxx")
public class Jgywpt_MjjbxxController extends PublicService {
    ...
    /**
     * @api {get} /v4/jgywpt/mjjbxx/mjxxList 民警信息查询
     * @apiVersion 0.4.0
     * @apiName mjxxList
     * @apiGroup g_jgywpt
     * @apiPermission any
    ...
    public ResponseMessage<Map<String, Object>> mjxxList(HttpServletRequest request, @RequestParam(name = "appcode")String appcode, @RequestParam(name = "jsbh")String jsbh, String json) {
        ...
        String interfaceId = "/v4/jgywpt/mjjbxx/mjxxList";
