...
public class Manager_MirisController {
    @Autowired
    ...
    public ResponseMessage<PagerResult<Manager_MirisModel>> miris_query(HttpServletRequest request,
        ...
        return managerService.miris_query(queryParam);
    }
}
