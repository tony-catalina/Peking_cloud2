...
public class Manager_ZirisController {
    @Autowired
    ...
    public ResponseMessage<PagerResult<Manager_ZirisModel>> ziris_query(HttpServletRequest request,
        ...
        return managerService.ziris_query(queryParam);
    }
}
