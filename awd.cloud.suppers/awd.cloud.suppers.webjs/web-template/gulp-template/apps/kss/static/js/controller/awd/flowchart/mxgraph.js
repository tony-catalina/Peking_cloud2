define(function (require) {
    ...
    var main = {
        ...
        bindAction: function (nodes) {
            ...
            graph.addListener(mxEvent.CLICK, function (sender, evt) {
                ...
                if (cell11 == null) {
                    ...
                    var url=geturl(cell11.id, nodes);
        ...
        configureStylesheet: function (graph,id,option) {
            ...
            style[mxConstants.STYLE_STROKECOLOR] = tools.isUndefined(option['STYLE_STROKECOLOR'])?'#f8fffe':option['STYLE_STROKECOLOR'];
            style[mxConstants.STYLE_FILLCOLOR] = tools.isUndefined(option['STYLE_FILLCOLOR'])?'#f8fffe':option['STYLE_FILLCOLOR'];
