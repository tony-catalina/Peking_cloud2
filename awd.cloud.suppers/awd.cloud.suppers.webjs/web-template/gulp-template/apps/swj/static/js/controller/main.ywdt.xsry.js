define(function (require) {
    ...
    var kssclumn=require('models/kss/clumns');
    var jlsclumn=require('models/jls/clumns');
    var jdsclumn=require('models/jds/clumns');
    var jhylclumn=require('models/jhyl/clumns');
    var qzylclumn=require('models/qzyl/clumns');
    var jsdtTpl = require('services/jsdt');
