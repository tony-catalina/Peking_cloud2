    ...
    return {
                ...
                },
                {
                    ...
                    'menus': [{
                        ...
                        },
                        {
                            ...
                            'menuname': '入所记录',
                            'icon': 'fa-laptop',
                            'url': 'kss/ywcx/rsjl.html'
                        },
                        {
                            'menuid': '126',
                            'menuname': '提审记录',
                            'icon': 'fa-laptop',
                            'url': 'kss/ywcx/tsjl.html'
                        },
                        {
                            'menuid': '127',
                            'menuname': '环节变动',
                    ...
                    'menus': [{
                        ...
                        },
                        {
                            ...
                            'menuname': '严重疾病分析',
                            'icon': 'fa-laptop',
                            'url': 'kss/xxyp/yzjbfx.html'
                        },
                        {
                            'menuid': '173',
                            'menuname': '关押期限分析',
                            'icon': 'fa-laptop',
                            'url': 'kss/xxyp/gyxqfx.html'
                        },
                        {
                            'menuid': '174',
                            'menuname': '国籍分析',
                ...
                },
                {
                    ...
                    'menus': [{
                        ...
                        },
                        {
                            ...
                            'menuname': '民警信息查询',
                            'icon': 'fa-window-restore',
                            'url': 'jls/rycx/mjxxcx.html'
                        },
                        {
                            'menuid': '212',
                            'menuname': '工作人员查询',
                            'icon': 'fa-window-maximize',
                            'url': 'jls/rycx/gzrycx.html'
                        },
                        {
                            'menuid': '213',
                            'menuname': '办案人员查询',
                            'icon': 'fa-window-maximize',
                            'url': 'jls/rycx/barycx.html'
                        },
                        {
                            'menuid': '214',
                            'menuname': '律师信息查询',
                            'icon': 'fa-window-maximize',
                            'url': 'jls/rycx/lsxxcx.html'
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    'menus': [{
                        ...
                        },
                        {
                            ...
                            'menuname': '民警信息查询',
                            'icon': 'fa-window-restore',
                            'url': 'jds/rycx/mjxxcx.html'
                        },
                        {
                            'menuid': '312',
                            'menuname': '工作人员查询',
                            'icon': 'fa-window-maximize',
                            'url': 'jds/rycx/gzrycx.html'
                        },
                        {
                            'menuid': '313',
                            'menuname': '办案人员查询',
                            'icon': 'fa-window-maximize',
                            'url': 'jds/rycx/barycx.html'
                        }
                    ]
                }, {
                    'menuid': '32',
        ...
        'menus': [{
                ...
                },
                {
                    ...
                    'icon': 'fa-window-restore',
                    'parentMenu': '7',
                    'url': 'yzd/jsyw/mrqkcx.html',
                //     'menus': [{
                //         'menuid': '0',
                //         'menuname': '自杀自残',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/zszc.html',
                //     },
                //     {
                //         'menuid': '1',
                //         'menuname': '打架斗殴',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/djdo.html',
                //     },
                //     {
                //         'menuid': '2',
                //         'menuname': '突发疾病',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/tfjb.html',
                //     },
                //     {
                //         'menuid': '3',
                //         'menuname': '矛盾化解',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/mdhj.html',
                //     },
                //     {
                //         'menuid': '4',
                //         'menuname': '深挖犯罪',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/swfz.html',
                //     },
                //     {
                //         'menuid': '5',
                //         'menuname': '核实身份',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/hssf.html',
                //     },
                //     {
                //         'menuid': '6',
                //         'menuname': '锦旗感谢信',
                //         'icon': 'fa-window-restore',
                //         'url': 'yzd/jsyw/jqgxx.html',
                //     },
                // ]
                },
                {
            ...
            },
            {
                ...
                'menus': [{
                        ...
                        'menuname': '监所医疗信息统计',
                        'icon': 'fa-window-restore',
                        'url': 'ezd/gayyjzxx/jsylxxtj.html'
                        },
                        {
                        'menuid': '531',
                        'menuname': '入所体检信息',
                        'icon': 'fa-window-restore',
                        'url': 'ezd/gayyjzxx/rstjxx.html'
                        },
                        {
                        'menuid': '532',
                        'menuname': '重点病人信息',
                        'icon': 'fa-window-maximize',
                        'url': 'ezd/gayyjzxx/zdbrxx.html'
                        },
                        {
                        'menuid': '533',
                        'menuname': '传染病人信息',
                        'icon': 'fa-window-maximize',
                        'url': 'ezd/gayyjzxx/crbrxx.html'
                        },
                        {
                        'menuid': '534',
                        'menuname': '医疗巡诊信息',
                        'icon': 'fa-window-maximize',
                        'url': 'ezd/gayyjzxx/ylxzxx.html'
                        },
                        {
                        'menuid': '535',
                        'menuname': '所内就医信息',
                        'icon': 'fa-window-maximize',
                        'url': 'ezd/gayyjzxx/snjyxx.html'
                        },
                        {
                        'menuid': '536',
                        'menuname': '出所就医信息',
                        'icon': 'fa-window-maximize',
                        'url': 'ezd/gayyjzxx/csjyxx.html'
                        }]
    },
    {
                'menuid': '54',
                ...
                'menus': [{
                        ...
                        'icon': 'fa-window-restore',
                        'url': 'ezd/jsylxx/gayyjzfzjczl.html'
                        }]
    },
    {
        'menuid': '55',
