...
// File created 30-Dec-2009 02:50:29 for Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US) AppleWebKit/532.6 (KHTML, like Gecko) Chrome/4.0.266.0 Safari/532.6
var mxClient = {
    VERSION: '1.2.0.5',
...
var mxUtils = {
    ...
    eval: function(expr) {
        var result = null;
        if (expr.indexOf('function') >= 0 && (false || false || false || false || true)) {
            try {
...
if (window.location.hostname != 'mxgraph.com' && window.location.hostname != 'www.mxgraph.com') {
    ...
    if (i == len) {
        if ((new Date().getTime() / 1000) - 1262141429 > 15778463) {
            mxGraph = null;
        };
...
mxGraphView.prototype.init = function() {
    ...
    if (container != null) {
        ...
        function(evt) {
            if (this.isContainerEvent(evt) && ((!false && !true && !false && !false) || !this.isScrollEvent(evt))) {
