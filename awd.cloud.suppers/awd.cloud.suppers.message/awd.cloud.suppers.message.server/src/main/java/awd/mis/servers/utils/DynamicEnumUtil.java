...
//
//        System.out.println(Arrays.deepToString(ClassifyEnum.values()));
//        // Dynamically add 1 instance
//        addEnum(ClassifyEnum.class, "1", new Class[]{String.class,String.class}, new Object[]{"1q", "2w"});
//        addEnum(ClassifyEnum.class, "2", new Class[]{String.class,String.class}, new Object[]{ "2a", "2b"});
//        // Run a few tests just to show it works OK.
//        System.out.println(Arrays.deepToString(ClassifyEnum.values()));
//        ClassifyEnum c = ClassifyEnum.valueOf("1");
