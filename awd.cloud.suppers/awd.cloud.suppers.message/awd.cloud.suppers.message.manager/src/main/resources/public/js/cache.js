    ...
    function showNotice(){
        layer.open({
            ...
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">' +
                ...
                '避免使用中遇到一些简单的问题造成困扰。' +
                '</p></pclass></p><p>' +
                '1.0发布以后发现很多朋友将代码上传到各种素材网站，' +
                '当然这样帮我宣传我谢谢大家，但是有部分朋友上传到素材网站后将下载分值设置的相对较高，' +
                '需要朋友们充钱才能下载。本人发现后通过和站长、' +
                '网站管理员联系以后将分值调整为不需要充值才能下载或者直接免费下载。在此郑重提示各位：' +
                '<span class="layui-red">本模版已进行作品版权证明，不管以何种形式获取的源码，' +
                '请勿进行出售或者上传到任何素材网站，否则将追究相应的责任。</span></p></div>',
