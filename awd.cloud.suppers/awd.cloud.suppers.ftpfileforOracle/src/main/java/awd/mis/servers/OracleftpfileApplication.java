...
@MonitoredWithSpring
@EnableScheduling
public class OracleftpfileApplication implements CommandLineRunner{
    ...
    public static void main(String[] args) {
    	SpringApplication.run(OracleftpfileApplication.class,args);
	}
    ...
    public SqlExecutor sqlExecutor(DataSource dataSource) {    
        DataSourceHolder.install(dataSource, DatabaseType.oracle);
