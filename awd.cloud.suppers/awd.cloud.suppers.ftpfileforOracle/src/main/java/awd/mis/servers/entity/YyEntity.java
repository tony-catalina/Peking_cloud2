...
public class YyEntity extends SimpleGenericEntity<String>  {
	...
	//alias
	public static final String TABLE_ALIAS = "预约";
    ...
    @Length(max=21,message="id最大长度21位" ,groups=CreateGroup.class)
	private java.lang.String id;

    @Length(max=21,message="预约ID最大长度21位" ,groups=CreateGroup.class)
	private java.lang.String yyid;

    @Length(max=21,message="律师证号最大长度21位" ,groups=CreateGroup.class)
    ...
    @Length(max=30,message="人员姓名最大长度30位" ,groups=CreateGroup.class)
    ...
    @Length(max=20,message="会见室最大长度20位" ,groups=CreateGroup.class)
	private java.lang.String hjs;

    @Length(max=1,message="是否撤销  0代表未撤销，1代表撤销最大长度1位" ,groups=CreateGroup.class)
	private java.lang.String revokes;

    @Length(max=600,message="撤销原因最大长度600位" ,groups=CreateGroup.class)
	private java.lang.String reasom;

    @Length(max=1,message="会见类型  1律师提出的预约会见 2在押人员要求的律师会见最大长度1位" ,groups=CreateGroup.class)
    ...
    @Length(max=5,message="r3删除 R2显示最大长度5位" ,groups=CreateGroup.class)
	private java.lang.String state;

    @Length(max=30,message="操作人最大长度30位" ,groups=CreateGroup.class)
	private java.lang.String operator;

    @Length(max=1,message="上传标志最大长度1位" ,groups=CreateGroup.class)
	private java.lang.String scbz;

    @Length(max=2000,message="备注最大长度2000位" ,groups=CreateGroup.class)
    ...
    @Length(max=1,message="状态   0审核中 1通过 2 未通过最大长度1位" ,groups=CreateGroup.class)
	private java.lang.String flag;

    @Length(max=30,message="律师姓名最大长度30位" ,groups=CreateGroup.class)
	private java.lang.String lsxm;

    @Length(max=60,message="律师单位最大长度60位" ,groups=CreateGroup.class)
	private java.lang.String lsdw;

    @Length(max=30,message="单位电话最大长度30位" ,groups=CreateGroup.class)
	private java.lang.String dwdh;

    @Length(max=50,message="律师手机号最大长度50位" ,groups=CreateGroup.class)
	private java.lang.String sjh;

    @Length(max=1,message="是否是律师会见还是提审会见最大长度1位" ,groups=CreateGroup.class)
