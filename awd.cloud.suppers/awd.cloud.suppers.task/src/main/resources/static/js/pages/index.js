...
function(require) {
	...
	var awd_pop=require("../bootstrap/awd.pop");
	var awd_bootstrap_growl=require("../bootstrap/awd.bootstrap_growl");
	var _init=function(){
		// :: Variables
