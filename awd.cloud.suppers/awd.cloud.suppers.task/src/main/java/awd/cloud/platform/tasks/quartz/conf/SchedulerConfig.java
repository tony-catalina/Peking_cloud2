package awd.cloud.platform.tasks.quartz.conf;
...
import awd.cloud.platform.tasks.quartz.job.QuartzJobFactory;
import awd.cloud.platform.tasks.quartz.job.ScheduleJob;
import awd.cloud.platform.tasks.quartz.spring.AutowiringSpringBeanJobFactory;
import awd.framework.common.datasource.api.annotation.UseDefaultDataSource;
