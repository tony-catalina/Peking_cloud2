...
public class MzwtxEntity extends SimpleGenericEntity<String> {
    ...
    @Length(max=1,message="上次标志最大长度1位" ,groups=SaveGroup.class)
	private java.lang.String scbz;

    @Length(max=21,message="证件号最大长度21位" ,groups=SaveGroup.class)
